%% This tutorial is designed to give an understanding of how nonprigid mapping 
...
%% Create shape mapper and map shape
SM = ShapeMapper;
...
SM.FlagTargetBoundary = true; % whether to ignore points that correspond to a point on the edge of the target face
