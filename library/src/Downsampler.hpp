...
public:
  ...
  void set_output(FeatureMat &outFeatures, FacesMat &outFaces,
                  VecDynFloat &outFlags, VecDynInt &outOriginalIndices);
  void set_output(FeatureMat &outFeatures, FacesMat &outFaces,
                  VecDynFloat &outFlags);
  void set_parameters(float downsampleRatio = 0.8f) {
